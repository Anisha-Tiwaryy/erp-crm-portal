...
| Warehouse | `warehouse@erpdemo.com` | Products, stock, confirm challans |
| Accounts | `accounts@erpdemo.com` | Read only |
...
The login form is pre-filled with the admin account.
